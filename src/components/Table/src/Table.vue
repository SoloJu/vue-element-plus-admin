<script lang="tsx">
import { ElTable, ElTableColumn, ElPagination, ComponentSize, ElTooltipProps, ElImage } from 'element-plus'
            ...
            return (
                <div v-loading={unref(getProps).loading}>
                    {unref(getProps).showAction ? (
                        <TableActions columns={unref(getProps).columns} onChangSize={changSize} onRefresh={refresh} />
                    ) : null}
