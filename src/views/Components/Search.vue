...
<template>
    <ContentWrap :title="`${t('searchDemo.search')} ${t('searchDemo.operate')}`" style="margin-bottom: 20px">
        ...
        <ElButton @click="changeGrid(false)"> {{ t('searchDemo.restore') }} {{ t('searchDemo.grid') }} </ElButton>

        <ElButton @click="changeLayout"> {{ t('searchDemo.button') }} {{ t('searchDemo.position') }} </ElButton>
        ...
        <ElButton @click="getDictOne"> {{ t('formDemo.select') }} {{ t('searchDemo.dynamicOptions') }} </ElButton>
        ...
        <ElButton @click="changeSearchLoading"> {{ t('searchDemo.search') }} {{ t('searchDemo.loading') }} </ElButton>
        <ElButton @click="changeResetLoading"> {{ t('searchDemo.reset') }} {{ t('searchDemo.loading') }} </ElButton>
    </ContentWrap>
